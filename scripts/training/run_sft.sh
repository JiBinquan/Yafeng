...
pretrained_model=/data0/jibinquan/model/chinese-alpaca-2-7b
#chinese_tokenizer_path=path/to/chinese-llama-2/tokenizer/dir
chinese_tokenizer_path=/data0/jibinquan/model/chinese-alpaca-2-7b
dataset_dir=/data0/jibinquan/homework/Chinese-LLaMA-Alpaca-2-main/data/train_data
per_device_train_batch_size=1
per_device_eval_batch_size=1
gradient_accumulation_steps=8
max_seq_length=512
output_dir=/data0/jibinquan/homework/Chinese-LLaMA-Alpaca-2-main/check_point
validation_file=/data0/jibinquan/homework/Chinese-LLaMA-Alpaca-2-main/data/test.json
